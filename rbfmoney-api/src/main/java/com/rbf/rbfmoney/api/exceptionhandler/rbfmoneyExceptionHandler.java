package com.rbf.rbfmoney.api.exceptionhandler;
...
@ControllerAdvice
public class rbfmoneyExceptionHandler extends ResponseEntityExceptionHandler{
	...
	//Trata exceções do tipo recurso não encontrado
	...
	//Recebe mensagens de erro e adiciona na lista
